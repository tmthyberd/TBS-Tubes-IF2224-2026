...
{
    auto node = std::unique_ptr<ParseTreeNode>(new ParseTreeNode("<relational-operator>"));
...
{
    auto node = std::unique_ptr<ParseTreeNode>(new ParseTreeNode("<additive-operator>"));
    node->addToken(ts.advance());
    return node;
}
...
{
    auto node = std::unique_ptr<ParseTreeNode>(new ParseTreeNode("<multiplicative-operator>"));
    node->addToken(ts.advance());
    return node;
}
...
{
    auto node = std::unique_ptr<ParseTreeNode>(new ParseTreeNode("<index-list>"));
...
{
    auto node = std::unique_ptr<ParseTreeNode>(new ParseTreeNode("<component-variable>"));
...
{
    auto node = std::unique_ptr<ParseTreeNode>(new ParseTreeNode("<variable>"));
...
{
    auto node = std::unique_ptr<ParseTreeNode>(new ParseTreeNode("<parameter-list>"));
...
{
    auto node = std::unique_ptr<ParseTreeNode>(new ParseTreeNode("<factor>"));
...
{
    auto node = std::unique_ptr<ParseTreeNode>(new ParseTreeNode("<term>"));
...
{
    auto node = std::unique_ptr<ParseTreeNode>(new ParseTreeNode("<simple-expression>"));
...
{
    auto node = std::unique_ptr<ParseTreeNode>(new ParseTreeNode("<expression>"));
